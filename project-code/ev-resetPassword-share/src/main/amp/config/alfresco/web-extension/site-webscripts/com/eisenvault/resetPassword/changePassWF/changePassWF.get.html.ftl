<#if !showError>
    ...
    <@link href="${url.context}/res/extras/com/eisenvault/components/changePassWF.css" group="form"/>
    <@script type="text/javascript" src="${url.context}/res/components/form/form.js" group="form"/>
    <@script type="text/javascript" src="${url.context}/res/extras/com/eisenvault/components/changePassWF.js"/>
...
<div id="${id}" class="fields">
    <form id="${id}-form" class="formaa"
          action="${url.context}/proxy/alfresco-noauth/com/eisenvault/applyChangedPassword"
          method="post">
