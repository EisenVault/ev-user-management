function main()
{
   ...
   // EisenVault - Monica Kumari
   if(usersCreationLimitCheck.isNumberOfUsersLimitExceeded()==true)
   {
	   status.setCode(status.STATUS_PRECONDITION_FAILED, "Can't create. Users count exceeded");
	   return;
   }
