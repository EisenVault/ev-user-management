...
public class WorkflowHelper {
    ...
    private static final String DEPLOY_DEFINITION_ERROR = "Failed to load 'activiti$reset-Password-custom' definition: file 'ResetPasswordProcess.bpmn20.xml' not found";
        ...
        TenantUtil.runAsUserTenant(new TenantUtil.TenantRunAsWork<Object>() {
            ...
            public Object doWork() throws Exception {
                ...
                for (WorkflowTask task : workflowTasks) {
                    ...
                    if ("ev-reset:review".equals(task.getName())) {
                        if (logger.isDebugEnabled()) {
    ...
    public static WorkflowDefinition deployResetPasswordWorkflow() {
        ...
        return workflowService.getDefinitionByName("activiti$reset-Password-custom");
    }
