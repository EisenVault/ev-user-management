package com.eisenvault.resetpassword.webscripts;
...
import com.eisenvault.resetpassword.util.WorkflowHelper;
    ...
    private void startWorkFlow(final NodeRef user, final String tenantDomain) {
        AuthenticationUtil.runAsSystem(new AuthenticationUtil.RunAsWork<Object>() {
            ...
            public Object doWork() throws Exception {
                ...
                WorkflowDefinition workflowDefinition = workflowService.getDefinitionByName("activiti$reset-Password-custom");
